...
const events = [
  { 
    ...
    type: 'HACKATHON',
    title: 'Avishkaar 4.0', 
    tagline: 'Build. Innovate. Create the Future.',
    duration: '48 Hours',
    prize: '₹ 1,00,000',
    venue: 'Auditorium, Tech Valley Campus',
    icon: Lightbulb,
  ...
  { 
    ...
    tagline: 'Craft seamless experiences and intuitive designs.',
    duration: '24 Hours',
    prize: '₹ 50,000',
    venue: 'Design Lab, Block B',
    icon: Palette,
  ...
  { 
    ...
    title: 'Code Crush', 
    tagline: 'Solve complex algorithms in record time.',
    duration: '12 Hours',
    prize: '₹ 25,000',
  ...
  { 
    ...
    tagline: 'Collaborate and push the boundaries of tech.',
    duration: '36 Hours',
    prize: '₹ 75,000',
        ...
        <section className="relative overflow-hidden rounded-2xl p-6 md:p-8 lg:p-10 border border-emerald-700/20 dark:border-emerald-500/30 bg-white dark:bg-emerald-950/10 flex justify-between items-center shadow-sm">
          <div className="max-w-2xl space-y-2.5 relative z-10">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">
              Hello, <span className="text-emerald-700 dark:text-emerald-500">User</span> 👋
            </h2>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            {events.map((event) => (
              ...
              >
                <div className={`w-full md:w-56 lg:w-64 aspect-square rounded-2xl bg-gradient-to-br ${event.gradient} flex items-center justify-center relative overflow-hidden shrink-0 border border-white/5`}>
                   ...
                   <div className="relative z-10 flex items-center justify-center">
                     ...
                     <event.icon className={`h-24 w-24 ${event.iconColor} drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]`} strokeWidth={1.5} />
                   </div>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-center py-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                    <div className="bg-slate-50 dark:bg-[#090b0e] border border-slate-200 dark:border-slate-800 rounded-xl p-3 md:p-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-900 dark:text-white text-sm font-semibold">{event.duration}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-slate-50 dark:bg-[#090b0e] border border-slate-200 dark:border-slate-800 rounded-xl p-3 md:p-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-900 dark:text-white text-sm font-semibold">{event.prize}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 dark:bg-[#090b0e] border border-slate-200 dark:border-slate-800 rounded-xl p-3 md:p-4 flex items-center gap-3 w-full">
                    ...
                    <div>
                      ...
                      <p className="text-slate-900 dark:text-white text-sm font-semibold">{event.venue}</p>
                    </div>
                  </div>
